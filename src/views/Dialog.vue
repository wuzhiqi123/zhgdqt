            ...
            <div class="form"  >
                ...
                <div  class = "user" style ="background: #c1b9bd ;">
                    ...
                    <el-row type="flex" class="row-bg" justify="center" >
                        <el-col :space="4"  >
                    <div class = "user_1" style="width:60%  ; float:right ;margin : 0px 20px 0px 0px">
                        <el-form-item prop='xm' label="姓名:">
                            <el-input type="xm" v-model="formData.xm" style = "float :left ;width:65%"></el-input>
                    ...
                    <div class = "user_2" style="width:60%  ;">
                        <el-form-item label="性别:"  >
                            <el-select v-model="formData.xb" placeholder="性别" style="width:100%  ;">
                                <el-option
                        ...
                        <el-form-item label="民族:"  >
                            <el-select v-model="formData.mz"  placeholder="民族" style="width:100%  ;">
                                <el-option
                        ...
                        <el-form-item label="政治面貌:"  >
                            <el-select v-model="formData.zzmm" placeholder="政治面貌" style="width:100%  ;">
                                <el-option
                        ...
                        <el-form-item label="工人所属队伍:"  >
                            <el-select v-model="formData.grssdw" placeholder="工人所属队伍" style="width:100%  ;" @change = "getbz">
                                <el-option
                        ...
                        <el-form-item label="工人所属班组:"  >
                            <el-select v-model="formData.grssbz" placeholder="工人所属班组" style="width:100%  ;">
                                <el-option
                        ...
                        <el-form-item label="工人工种:"  >
                            <el-select v-model="formData.grgz" placeholder="工人工种" style="width:100%  ;">
                                <el-option
                 ...
                 <div class = "user_3">
                     ...
                     <el-row type="flex" class="row-bg" justify="center" >
                     <el-col :space="4"  >
                    <div class = "user_4" style="width:60%  ; float:right ;margin : 0px 20px 0px 0px">
                    ...
                    <el-form-item label="文化程度:"  >
                        <el-select v-model="formData.whcd"   placeholder="文化程度" style="width:100%" >
                            <el-option
                ...
                <div  style="text-align:center">
                    <el-form-item  class="text_right">
                        ...
                        <el-button @click="next(formData)">保存并开始下一个</el-button>
    ...
    export default {
        ...
        methods:{
            ...
            getrouter(){
                    ...
                    this.formData.dwnm=this.$route.params.dwnm,
            ...
            getbz(val){
                for(let i = 0; i< this.format_grssdw_list.length ;i++){
                    if(this.format_grssdw_list[i].mc == val){
                       this.bzparma.nm =   this.format_grssdw_list[i].nm
                    }
                }
                this.getGrssbz(this.bzparma)
            },
            getGrssbz(bzparma){
